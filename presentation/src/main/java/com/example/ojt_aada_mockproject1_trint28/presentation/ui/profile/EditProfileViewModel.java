...
public class EditProfileViewModel extends ViewModel {
    ...
    private final IProfileRepository profileRepository; // Thay bằng interface
    ...
    @Inject
    public EditProfileViewModel(IProfileRepository profileRepository, ProfileUseCases profileUseCases) {
    ...
    private void saveProfileToDatabase(Profile updatedProfile) {
        disposables.add(
                profileRepository.saveProfile(updatedProfile) // Sử dụng IProfileRepository
                        .subscribeOn(Schedulers.io())
                        .observeOn(AndroidSchedulers.mainThread())
                        .subscribe(
